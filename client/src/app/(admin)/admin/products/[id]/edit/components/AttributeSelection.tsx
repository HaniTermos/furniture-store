...
<<<<<<< HEAD
    ...
    const updateSelected = (index: number, field: keyof SelectedAttribute, val: any) => {
                            ...
                            <div className="flex items-center gap-3 pt-4 sm:pt-6">
                                <label className="flex items-center gap-2 cursor-pointer group/toggle whitespace-nowrap">
                                    <div className="relative">
                                        <input
                                            type="checkbox"
                                            checked={selected.is_variation_maker}
                                            onChange={(e) => updateSelected(idx, 'is_variation_maker', e.target.checked)}
                                            className="sr-only"
                                        />
                                        <div className={`w-10 h-5 rounded-full transition-colors ${selected.is_variation_maker ? 'bg-primary-orange' : 'bg-neutral-200'}`} />
                                        <div className={`absolute top-0.5 left-0.5 w-4 h-4 bg-white rounded-full transition-transform shadow-sm ${selected.is_variation_maker ? 'translate-x-5' : ''}`} />
                                    </div>
